...
def load_data(
    *,
    ...
    if dataset_mode == 'cityscapes':
        ...
        all_files = _list_image_files_recursively(os.path.join(data_dir, 'train_img' if is_train else 'val_img'))
        classes = _list_image_files_recursively(os.path.join(data_dir, 'train_label' if is_train else 'val_label'))
        instances = _list_image_files_recursively(os.path.join(data_dir, 'train_inst' if is_train else 'val_inst'))
